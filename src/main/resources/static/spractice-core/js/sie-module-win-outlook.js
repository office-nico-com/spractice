// アウトルックモジュール
var SieModuleWinOutlook = function(moduleId, _account){
	this.id = moduleId;
	this.title = "Outlook";
...
//---------------------
	...
	this.view += '<div class="outlook-folder-title2"><i class="fa fa-caret-down" aria-hidden="true"></i>' + this.account + '</div>';
...
*/
	...
	this.addOnCreateEvent(function(params){
		...
		for(var i=0; i<_self.resources.length; i++){
			...
			li +=  '<div class="from">' + _self.resources[i]['from'] + ' &lt;' + _self.resources[i]['from_addr'] + '&gt;</div>';
	...
	this.showMail=function(index){
		...
		html += '<div class="message-head from">' + _self.resources[index]['from'] + '＜' + _self.resources[index]['from_addr'] + '＞' + '　｜　' + _self.resources[index]['to'] + '　' + _self.resources[index]['recieved_time'] +  '</div>';
...
*/
			...
			html += '<div class="attachment dl" data-index="' + index + '" data-attachment="' + 0 + '">';
			html += '<img src="' + _self.resources[index]['attachments'][0]['icon'] + '" height="46">';
			html += '<div class="info">';
			html += '<span class="file-name">' + _self.resources[index]['attachments'][0]['file_name'] + '</span><br/><span class="size">' + _self.resources[index]['attachments'][0]['file_size'] + '</span>';
			html += '</div>';
			html += '</div>';
